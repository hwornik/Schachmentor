========================================================================
    KONSOLENANWENDUNG: Schachmentor-Projektübersicht
========================================================================

Diese Schachmentor-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Schachmentor-Anwendung besteht.


Schachmentor.vcxproj
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Schachmentor.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
